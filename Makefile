...
.PHONY: all
all: clean bin $(CLIENT1_BIN) $(CLIENT2_BIN) test

bin:
	mkdir -p bin

$(CLIENT1_BIN): $(CLIENT1_SRC) src/protocol.h bin
	$(CC) $(CFLAGS) -o $(CLIENT1_BIN) $(CLIENT1_SRC) $(PROTOCOL_SRC)

$(CLIENT2_BIN): $(CLIENT2_SRC) src/protocol.h bin
	$(CC) $(CFLAGS) -o $(CLIENT2_BIN) $(CLIENT2_SRC) $(PROTOCOL_SRC)
...
.PHONY: test
test: $(TEST_PROTOCOL_BIN) $(TEST_CLIENT1_BIN) $(TEST_CLIENT2_BIN)
	./$(TEST_PROTOCOL_BIN)
	./$(TEST_CLIENT1_BIN)
	./$(TEST_CLIENT2_BIN)
